...
* A 128-bit [security level][dspa20] (see section 4.2 for an introduction to this concept) for confidentiality, authenticity and integrity against passive and active adversaries[^seclevel]. <p> For comparison, the current (2013) deployments of HTTPS provide 73-bit security at most, which seems likely to be within the reach of Nation State Adversaries (NSA). </p>
